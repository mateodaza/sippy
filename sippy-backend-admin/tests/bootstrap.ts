...
// Registry is generated by @tuyau/core during dev mode.
// When it doesn't exist, route typing falls back to string.
// @ts-ignore — file may not exist until `node ace serve` runs
