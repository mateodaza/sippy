...
| --- | ----------------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Onramp integration (API, testing, user flow)                | Blocked | Transak + TransFi KYB submitted Mar 23 for CO. Coinbase Onramp live for non-CO.                                                                                                  |
...
| 4   | Dual currency display (USD + local)                         | 100%    | P3 (26 LATAM currencies, 24h cache) + local currency sends ("2mil pesos" auto-converts)                                                                                          |
...
| 8   | Legal entity establishment                                  | 100%    | SIPPY, S.A. DE C.V. incorporated in El Salvador (Mar 20, 2026)                                                                                                                   |
| 9   | WhatsApp production number active                           | 100%    | Done                                                                                                                                                                             |
| 10  | Closed beta: 50 testers + onramp                            | 90%     | 45 users onboarded, $4K+ USDC volume. 5 more testers needed.                                                                                                                     |
