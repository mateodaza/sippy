    ...
    return (
      <div className="bg-[var(--bg-primary)] panel-frame rounded-2xl p-8 text-center">
        ...
        <p className="text-[var(--text-secondary)] mb-4">
          If your purchase completed successfully, the USDC should appear in the Sippy account
          within a few minutes. Check the balance on WhatsApp to confirm.
        </p>
        <button
    ...
    <Shell>
      <div className="text-center py-16">
        ...
        <div className="max-w-sm mx-auto">
          ...
          >
            {lookupLoading ? <Loader2 className="w-5 h-5 animate-spin" /> : 'Find Account'}
          </button>
        </div>
      </div>
    </Shell>
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-6 md:py-8">{children}</div>
      </section>
    </div>
  )
}
