...
export async function dispatchCommand(
  ...
  await routeCommand(from, command, lang, rateCtx, balanceHandler, sendHandler)
}
...
export default class WebhookController {
  ...
  private async processWebhook(payload: WebhookPayload): Promise<void> {
    ...
    await this.handleCommand(from, command, lang, rateCtx)
  ...
  private async handleCommand(
    ...
    await routeCommand(phoneNumber, command, lang, rateCtx)
  }
}
