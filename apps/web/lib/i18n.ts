...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'landing.hero.sub2': 'sin app. sin banco.',
    ...
    'landing.marquee.2': 'Las remesas cuestan 6%',
    ...
    'landing.pill.5': 'Comercio Transfronterizo',
    'landing.pill.6': 'Apoyo Familiar',
  ...
  pt: {
    ...
    'landing.hero.sub2': 'sem app. sem banco.',
    'landing.hero.openWhatsapp': 'Abrir WhatsApp',
    ...
    'landing.marquee.2': 'Remessas custam 6%',
    ...
    'landing.pill.5': 'Com\u00e9rcio Internacional',
    'landing.pill.6': 'Apoio Familiar',
