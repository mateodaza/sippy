...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://sippy.lat/about',
  },
  openGraph: {
    title: 'About Sippy - WhatsApp USDC Payments on Arbitrum',
    description: 'USDC payment agent on Arbitrum One for Latin America. Dollars on WhatsApp.',
    type: 'website',
  },
}
        ...
        <div className="max-w-[75vw] sm:max-w-3xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-5">
              ...
              <div>
                <h3 className="font-display text-lg font-bold uppercase text-[var(--text-primary)] mb-1">
                  {t('about.pillar1.title', lang)}
                </h3>
                <p className="text-[15px] text-[var(--text-secondary)] leading-[1.75]">
        ...
        <div className="max-w-7xl mx-auto px-6 py-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <nav
              ...
              className="flex flex-wrap gap-x-6 gap-y-2 text-[13px] text-[var(--text-secondary)]"
            >
              <Link
                href="/"
