            ...
            <div className='max-w-none text-[var(--text-secondary)] [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-bold [&_h2]:uppercase [&_h2]:text-[var(--text-primary)] [&_h2]:mt-8 [&_h2]:mb-4 [&_p]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-4 [&_li]:mb-1 [&_a]:text-brand-primary [&_a]:hover:text-brand-primary-hover'>
              ...
              <section className='mb-10'>
                ...
                <div className='bg-[var(--bg-secondary)] rounded-xl p-6 border border-brand-primary/10'>
                  <p className='text-[var(--text-secondary)] font-medium'>{t('terms.s2.name', lang)}</p>
              ...
              <section className='mb-10'>
                ...
                <p className='text-[var(--text-secondary)] leading-relaxed mb-4'>{t('terms.s3.intro', lang)}</p>
              ...
              <section className='mb-10'>
                ...
                <p className='text-[var(--text-secondary)] leading-relaxed mb-4'>{t('terms.s4.intro', lang)}</p>
                <ul className='list-disc pl-6 text-[var(--text-secondary)] space-y-2'>
              ...
              <section className='mb-10'>
                ...
                <p className='text-[var(--text-secondary)] leading-relaxed mb-4'>{t('terms.s6.intro', lang)}</p>
                <ul className='list-disc pl-6 text-[var(--text-secondary)] space-y-2'>
                  <li><strong>{t('terms.s6.item1', lang)}</strong></li>
                  <li><strong>{t('terms.s6.item2', lang)}</strong></li>
                  <li><strong>{t('terms.s6.item3', lang)}</strong></li>
                </ul>
                <p className='text-[var(--text-secondary)] leading-relaxed mt-4'>
              ...
              <section className='mb-10'>
                ...
                <p className='text-[var(--text-secondary)] leading-relaxed mb-4'>{t('terms.s7.intro', lang)}</p>
                <ul className='list-disc pl-6 text-[var(--text-secondary)] space-y-2'>
              ...
              <section className='mb-10'>
                ...
                <ul className='list-disc pl-6 text-[var(--text-secondary)] space-y-2'>
                  <li><strong>{t('terms.s8.item1', lang)}</strong></li>
                  <li><strong>{t('terms.s8.item2', lang)}</strong></li>
                  <li><strong>{t('terms.s8.item3', lang)}</strong></li>
                  <li><strong>{t('terms.s8.item4', lang)}</strong></li>
                </ul>
              </section>
              ...
              <section className='mb-10'>
                ...
                <p className='text-[var(--text-secondary)] leading-relaxed mb-4'>{t('terms.s11.intro', lang)}</p>
                <ul className='list-disc pl-6 text-[var(--text-secondary)] space-y-2'>
                  <li><strong>{t('terms.s11.item1', lang)}</strong></li>
                  <li><strong>{t('terms.s11.item2', lang)}</strong></li>
                  <li><strong>{t('terms.s11.item3', lang)}</strong></li>
                </ul>
                <p className='text-[var(--text-secondary)] leading-relaxed mt-4'>
              ...
              <section className='mb-10'>
                ...
                <p className='text-[var(--text-secondary)] leading-relaxed mb-4'>{t('terms.s12.intro', lang)}</p>
                <ul className='list-disc pl-6 text-[var(--text-secondary)] space-y-2'>
              ...
              <section className='mb-10'>
                ...
                <ul className='list-disc pl-6 text-[var(--text-secondary)] space-y-2 mb-4'>
                  ...
                  <li><strong>{t('terms.s15.item2', lang)}</strong></li>
                  <li><strong>{t('terms.s15.item3', lang)}</strong></li>
                </ul>
                <h3 className='font-display text-lg font-bold uppercase text-[var(--text-primary)] mt-6 mb-3'>
                  {t('terms.s15.refunds.title', lang)}
                </h3>
                <ul className='list-disc pl-6 text-[var(--text-secondary)] space-y-2'>
                  <li><strong>{t('terms.s15.refunds.item1', lang)}</strong></li>
                  <li><strong>{t('terms.s15.refunds.item2', lang)}</strong></li>
                  <li><strong>{t('terms.s15.refunds.item3', lang)}</strong></li>
                </ul>
                <p className='text-[var(--text-secondary)] leading-relaxed mt-4'>
              ...
              <section className='mb-10'>
                <h2 className='font-display text-2xl font-bold uppercase text-[var(--text-primary)] mb-4'>{t('terms.s16.title', lang)}</h2>
                <p className='text-[var(--text-secondary)] leading-relaxed'>
              ...
              <section className='mb-10'>
                <h2 className='font-display text-2xl font-bold uppercase text-[var(--text-primary)] mb-4'>{t('terms.s17.title', lang)}</h2>
                <p className='text-[var(--text-secondary)] leading-relaxed'>
              ...
              <section className='mb-10'>
                <h2 className='font-display text-2xl font-bold uppercase text-[var(--text-primary)] mb-4'>{t('terms.s18.title', lang)}</h2>
                <p className='text-[var(--text-secondary)] leading-relaxed'>
              ...
              <section className='mb-6'>
                <h2 className='font-display text-2xl font-bold uppercase text-[var(--text-primary)] mb-4'>{t('terms.s19.title', lang)}</h2>
                <p className='text-[var(--text-secondary)] leading-relaxed mb-4'>{t('terms.s19.intro', lang)}</p>
                <div className='bg-brand-primary-light rounded-xl p-6 border border-brand-primary/20'>
                  <p className='text-[var(--text-primary)] font-medium text-lg'>{t('terms.s19.name', lang)}</p>
                  <p className='text-[var(--text-secondary)] font-medium'>{t('terms.s19.registration', lang)}</p>
                  ...
                  <p className='text-[var(--text-secondary)] text-sm mt-3'>{t('terms.s19.response', lang)}</p>
                </div>
              </section>
            </div>
          </div>
        ...
        <div className='max-w-4xl mx-auto px-6 py-8'>
          <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
            ...
            <nav aria-label='Footer navigation' className='flex gap-6 text-sm text-[var(--text-secondary)]'>
              ...
              <Link href='/privacy' className='hover:text-brand-primary transition-smooth font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary rounded'>{t('legal.privacyPolicy', lang)}</Link>
              <Link href='/terms' className='text-brand-primary font-medium'>{t('legal.termsOfService', lang)}</Link>
            </nav>
          </div>
        </div>
      </footer>
