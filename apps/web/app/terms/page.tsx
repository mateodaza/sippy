            ...
            <div className='max-w-none text-gray-500 [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-bold [&_h2]:uppercase [&_h2]:text-brand-dark [&_h2]:mt-8 [&_h2]:mb-4 [&_p]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-4 [&_li]:mb-1 [&_a]:text-brand-primary [&_a]:hover:text-brand-primary-hover'>
              ...
              <section className='mb-10'>
                ...
                <div className='bg-gray-50 rounded-xl p-6 border border-brand-primary/10'>
                  ...
                  <p className='text-gray-500'>Company registration in progress</p>
              ...
              <section className='mb-10'>
                ...
                <p className='text-gray-500 leading-relaxed mb-4'>To use our Service, you must:</p>
              ...
              <section className='mb-10'>
                ...
                <p className='text-gray-500 leading-relaxed mb-4'>Sippy provides a WhatsApp-based interface for:</p>
                <ul className='list-disc pl-6 text-gray-500 space-y-2'>
              ...
              <section className='mb-10'>
                ...
                <p className='text-gray-500 leading-relaxed mb-4'>The following limits apply to your use of the Service:</p>
                <ul className='list-disc pl-6 text-gray-500 space-y-2'>
              ...
              <section className='mb-10'>
                ...
                <p className='text-gray-500 leading-relaxed mb-4'>You agree NOT to use the Service for:</p>
                <ul className='list-disc pl-6 text-gray-500 space-y-2'>
              ...
              <section className='mb-10'>
                ...
                <p className='text-gray-500 leading-relaxed mb-4'>Our Service relies on third-party providers including:</p>
                <ul className='list-disc pl-6 text-gray-500 space-y-2'>
              ...
              <section className='mb-10'>
                ...
                <p className='text-gray-500 leading-relaxed mb-4'>To the maximum extent permitted by law:</p>
                <ul className='list-disc pl-6 text-gray-500 space-y-2'>
