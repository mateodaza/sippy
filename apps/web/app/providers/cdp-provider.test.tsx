...
// NO top-level static import of CDPProvider or getFreshToken.
...
describe('CDPProvider', () => {
  ...
  it('does not render CDPHooksProvider when project ID is absent', async () => {
    ...
    const { CDPProvider } = await import('./cdp-provider')
    renderComponent(React.createElement(CDPProvider, null, React.createElement('div')))
