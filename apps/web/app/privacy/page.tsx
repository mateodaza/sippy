...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://sippy.lat/privacy',
  },
}
        ...
        <div className="max-w-[75vw] sm:max-w-4xl mx-auto">
          <div className="panel-frame rounded-2xl bg-[var(--bg-primary)] p-8 md:p-12">
            <div className="max-w-none text-[var(--text-secondary)] [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-bold [&_h2]:uppercase [&_h2]:text-[var(--text-primary)] [&_h2]:mt-8 [&_h2]:mb-4 [&_p]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-4 [&_li]:mb-1 [&_a]:text-brand-primary [&_a]:hover:text-brand-primary-hover">
              ...
              <section className="mb-10">
                ...
                <div className="bg-[var(--bg-secondary)] rounded-xl p-6 border border-brand-primary/10">
                  <p className="text-[var(--text-secondary)] font-medium text-lg">
                    {t('privacy.s2.name', lang)}
                  </p>
                  <p className="text-[var(--text-secondary)] font-medium">
                    {t('privacy.s2.registration', lang)}
                  </p>
              ...
              <section className="mb-10">
                <h2 className="font-display text-2xl font-bold uppercase text-[var(--text-primary)] mb-4">
                  {t('privacy.s3.title', lang)}
                </h2>
                <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
                  {t('privacy.s3.intro', lang)}
                </p>
                <h3 className="font-display text-lg font-bold uppercase text-[var(--text-primary)] mt-6 mb-3">
                  {t('privacy.s3.provided.title', lang)}
                </h3>
                <ul className="list-disc pl-6 text-[var(--text-secondary)] space-y-2">
                  <li>
                    <strong>{t('privacy.s3.provided.item1', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s3.provided.item2', lang)}</strong>
                  </li>
                </ul>
                <h3 className="font-display text-lg font-bold uppercase text-[var(--text-primary)] mt-6 mb-3">
                  {t('privacy.s3.auto.title', lang)}
                </h3>
                <ul className="list-disc pl-6 text-[var(--text-secondary)] space-y-2">
                  <li>
                    <strong>{t('privacy.s3.auto.item1', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s3.auto.item2', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s3.auto.item3', lang)}</strong>
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 text-[var(--text-secondary)] space-y-2">
                  <li>
                    <strong>{t('privacy.s4.item1', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s4.item2', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s4.item3', lang)}</strong>
                  </li>
                </ul>
              ...
              <section className="mb-10">
                <h2 className="font-display text-2xl font-bold uppercase text-[var(--text-primary)] mb-4">
                  {t('privacy.s5.title', lang)}
                </h2>
                <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
                  {t('privacy.s5.intro', lang)}
                </p>
                <ul className="list-disc pl-6 text-[var(--text-secondary)] space-y-2">
                  <li>
                    <strong>{t('privacy.s5.item1', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s5.item2', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s5.item3', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s5.item4', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s5.item5', lang)}</strong>
                  </li>
                </ul>
                <p className="text-[var(--text-secondary)] leading-relaxed mt-4">
              ...
              <section className="mb-10">
                <h2 className="font-display text-2xl font-bold uppercase text-[var(--text-primary)] mb-4">
                  {t('privacy.s6.title', lang)}
                </h2>
                <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
                  {t('privacy.s6.intro', lang)}
                </p>
                <ul className="list-disc pl-6 text-[var(--text-secondary)] space-y-2">
              ...
              <section className="mb-10">
                <h2 className="font-display text-2xl font-bold uppercase text-[var(--text-primary)] mb-4">
                  {t('privacy.s7.title', lang)}
                </h2>
                <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
                  {t('privacy.s7.intro', lang)}
                </p>
                <ul className="list-disc pl-6 text-[var(--text-secondary)] space-y-3">
                  ...
                  <li>
                    <strong>{t('privacy.s7.item3', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s7.item4', lang)}</strong>
                  </li>
                  <li>
              ...
              <section className="mb-10">
                <h2 className="font-display text-2xl font-bold uppercase text-[var(--text-primary)] mb-4">
                  {t('privacy.s8.title', lang)}
                </h2>
                <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
                  {t('privacy.s8.intro', lang)}
                </p>
                <ul className="list-disc pl-6 text-[var(--text-secondary)] space-y-2">
                  <li>{t('privacy.s8.item1', lang)}</li>
                  <li>{t('privacy.s8.item2', lang)}</li>
                  <li>
                    <strong>{t('privacy.s8.item3', lang)}</strong>
                  </li>
              ...
              <section className="mb-10">
                <h2 className="font-display text-2xl font-bold uppercase text-[var(--text-primary)] mb-4">
                  {t('privacy.s9.title', lang)}
                </h2>
                <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
                  {t('privacy.s9.intro', lang)}
                </p>
                <ul className="list-disc pl-6 text-[var(--text-secondary)] space-y-2 mb-4">
                  <li>
                    <strong>{t('privacy.s9.item1', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s9.item2', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s9.item3', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s9.item4', lang)}</strong>
                  </li>
                </ul>
                <h3 className="font-display text-lg font-bold uppercase text-[var(--text-primary)] mt-6 mb-3">
                  {t('privacy.s9.deletion.title', lang)}
                </h3>
                <p className="text-[var(--text-secondary)] leading-relaxed">
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 text-[var(--text-secondary)] space-y-2">
                  <li>
                    <strong>{t('privacy.s10.item1', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s10.item2', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s10.item3', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s10.item4', lang)}</strong>
                  </li>
                  <li>
                    <strong>{t('privacy.s10.item5', lang)}</strong>
                  </li>
                </ul>
                <p className="text-[var(--text-secondary)] leading-relaxed mt-4">
              ...
              <section className="mb-6">
                ...
                <div className="bg-brand-primary-light rounded-xl p-6 border border-brand-primary/20">
                  <p className="text-[var(--text-primary)] font-medium text-lg">
                    {t('privacy.s13.name', lang)}
                  </p>
                  <p className="text-[var(--text-secondary)] font-medium">
                    {t('privacy.s13.registration', lang)}
                  </p>
