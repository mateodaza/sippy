            ...
            <div className='max-w-none text-gray-500 [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-bold [&_h2]:uppercase [&_h2]:text-brand-dark [&_h2]:mt-8 [&_h2]:mb-4 [&_p]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-4 [&_li]:mb-1 [&_a]:text-brand-primary [&_a]:hover:text-brand-primary-hover'>
              ...
              <section className='mb-10'>
                ...
                <ul className='list-disc pl-6 text-gray-500 space-y-3'>
                  ...
                  <li>
                    <strong>Coinbase (CDP - Coinbase Developer Platform):</strong> To securely create and manage payment accounts. Security keys are stored in Coinbase&apos;s secure infrastructure.{' '}
                  ...
                  <li><strong>Arbitrum Network:</strong> To process dollar transactions. Arbitrum is a public blockchain, meaning transaction data (amounts, addresses, timestamps) is publicly visible and permanently recorded.</li>
                  <li><strong>Blockscout:</strong> To retrieve transaction history and balance information.</li>
                  <li>
                    <strong>Groq (optional):</strong> When enabled, your message text may be sent to Groq&apos;s AI service for natural language processing to understand your commands. This feature can be disabled. Groq processes data per their{' '}
              ...
              <section className='mb-10'>
                ...
                <ul className='list-disc pl-6 text-gray-500 space-y-2'>
                  ...
                  <li>Transaction data is stored on the Arbitrum network (a public blockchain), which provides a permanent and publicly visible record.</li>
                </ul>
              </section>
