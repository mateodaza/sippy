...
export function ProfileHeader({
  ...
  return (
    <div className='mb-6 sm:mb-8 animate-fade-in-up'>
      {/* Main Balance Card */}
      <div className='relative bg-gradient-to-br from-[#00AFD7] via-[#0098BD] to-[#007A99] rounded-3xl sm:rounded-[32px] shadow-[0_20px_60px_rgba(0,175,215,0.25)] sm:shadow-[0_28px_80px_rgba(0,175,215,0.3)] p-6 border border-[#00AFD7]/20 overflow-hidden group hover:shadow-[0_32px_90px_rgba(0,175,215,0.35)] transition-all duration-500'>
        {/* Background Pattern */}
        ...
        <div className='relative z-10'>
          ...
          <div className='flex justify-center mt-8'>
            <button
              ...
              className='w-full max-w-xs py-3.5 bg-white hover:bg-gray-50 text-[#00AFD7] font-semibold rounded-xl transition-all duration-200 text-sm sm:text-base shadow-md hover:shadow-lg active:scale-[0.98] flex items-center justify-center gap-2'
            >
