...
export function ProfileHeader({
  ...
  return (
    <div className='mb-6 sm:mb-8 animate-fade-in-up'>
      {/* Main Balance Card */}
      <div className='relative bg-gradient-to-br from-brand-primary via-brand-primary-hover to-brand-primary-hover rounded-2xl p-6 border border-brand-primary/20 overflow-hidden group transition-smooth'>
        {/* Background Pattern */}
        ...
        <div className='relative z-10'>
          ...
          <div className='flex justify-center mt-8'>
            <button
              ...
              className='w-full max-w-xs py-3.5 bg-white hover:bg-brand-primary-light text-brand-primary font-semibold rounded-xl transition-smooth text-sm sm:text-base border border-brand-primary/20 active:scale-[0.98] flex items-center justify-center gap-2'
            >
