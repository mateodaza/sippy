      ...
      <div className='container mx-auto px-6 py-16 max-w-6xl'>
        ...
        <div className='text-center mb-24'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Connect, communicate, and manage your digital services through
            WhatsApp.
            <br />
            <span className='text-green-600 font-semibold'>
              Simple, secure, and available to everyone.
            </span>
          </p>
        </div>
        ...
        <footer className='text-center text-gray-500 space-y-4 pb-12 pt-8 border-t border-gray-200'>
          ...
          <p className='text-base text-gray-900 font-semibold'>
            SIPPY is owned and operated by{' '}
            <span className='font-bold'>Mateo Jose Daza Benjumea</span>.
          </p>
