...
- This transitions them to full self-custody if desired
- Exported wallets work with any Arbitrum-compatible wallet (MetaMask, Rainbow, etc.)
...
- Accounts inactive >12 months with no recovery email triggers a notification to last known contact
- Funds remain on-chain and accessible via private key export
...
The bill requires 3 more debates before becoming law. We're monitoring progress and designing for future compliance.

**AML/KYC Compliance (SARLAFT):**
Even without specific crypto regulation, we comply with Colombia's AML framework:
- **UIAF Resolution 314:** Crypto transactions >$150 USD-equivalent must be reported (since April 2022)
...
**Sippy Repository:**
The hackathon repository is currently private during active development. We're happy to provide reviewer access upon request. The repository will be made public as part of M4 deliverables (developer documentation and open source release).
...
4. **Open Source Components**
   - GasRefuel contract verified on Arbiscan with documentation
   - Sippy repository public with developer setup guide
...
7. **Final Report to Arbitrum DAO**
...
- Open source: GasRefuel verified, Sippy repo public
